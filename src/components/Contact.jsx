...
export const Contact = () => {
    ...
    <div name='contact' className='bg-gradient-to-r from-blue-800 to-indigo-900 h-screen w-full flex justify-center items-center p-4'>
        ...
        <div className='max-w-[1000px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl inline border-b-4 font-bold border-lime-300 text-gray-300'>Contacto</p>
            ...
            <form method='POST' action='https://getform.io/f/eapdyyza' className="max-w-[600px] w-full flex flex-col mx-auto">
                ...
                <button className='text-white border-2 hover:bg-gradient-to-r from-lime-500 to-lime-300 hover:border-lime-200 cursor-pointer px-4 py-3 my-4 mx-auto'>
                    Contactame
                </button>
            </form>
        </div>
